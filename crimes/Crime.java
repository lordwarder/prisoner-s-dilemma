...
public class Crime extends JTextArea {
    ...
    private static final String[] CRIMES = {
        ...
        "%s committed tax fraud while helping you fill out finantial documents. The IRS is suspicious of your financial activities, but they lack concrete evidence. If you disclose everything, you might be able to clear your name and bring %s to justice, but if you both %s, they might sentence you both with negligence. Do you keep quiet",
        "You and %s were caught possessing illegal substances, but they can't prove you were selling them. You might get away scott free if you claim %s was selling them. However, if you claim to both be users, you'll both recieve a much lighter sentence. refuse to admit?",
        "You and %s were involved in an insider trading scandal. The SEC is investigating, but they need your testimony to build a case. If you both refuse to cooperate, they may struggle to prove anything. will you stay silent?",
        ...
        //"You and %s stole a valuable painting from a museum. The museum has security footage of you, but they haven't identified you yet. If you turn yourself in, they'll go easy on you, but if you both %s, they may never catch you. Will you stay silent%s?",
        //"You and %s were caught bribing a public official. The authorities are investigating corruption, and they suspect you're involved. If you provide evidence against others, they may reduce your punishment, but if you both %s, they'll intensify their scrutiny. Will you not cooperate with the investigation?"
    };
